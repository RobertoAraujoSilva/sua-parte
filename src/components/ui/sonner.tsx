...
import * as ToastPrimitives from "sonner"
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Provider ref={ref} {...props} className={cn(className)} />
))
...
const Toast = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ToastPrimitives.Toast>
>(({ className, ...props }, ref) => (
